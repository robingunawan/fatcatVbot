...
async def spotify_search(client, message):
    ...
    search_url = f"https://api.botcahx.eu.org/api/search/spotify?query={query}&apikey=_moire_mor"
    ...
    caption = (f"""
<blockquote>🎵 <b>{track_title}</b>
👤 Artist: {artist_name}
⏳ Durasi: {track_duration}
🔗 <a href='{spotify_url}'>Dengarkan di Spotify</a></blockquote>""")
